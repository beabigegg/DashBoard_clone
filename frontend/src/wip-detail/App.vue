...
<template>
  <div class="dashboard wip-detail-page theme-wip-detail" data-testid="wip-detail-app">
    <div class="detail-page-nav">
      <button type="button" class="ui-btn ui-btn--ghost ui-btn--sm ui-btn--icon detail-back-btn" aria-label="返回 WIP Overview" @click="navigateBack"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="15 18 9 12 15 6"/></svg></button>
