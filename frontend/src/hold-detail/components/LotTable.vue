      ...
      <table class="lot-table">
        <thead>
          <tr>
            ...
            <th @click="toggleSort('spec')" style="cursor:pointer" :aria-sort="sortKey === 'spec' ? (sortDirection === 'asc' ? 'ascending' : 'descending') : 'none'">Spec <span>{{ sortKey === 'spec' ? (sortDirection === 'asc' ? '▲' : '▼') : '⇕' }}</span></th>
