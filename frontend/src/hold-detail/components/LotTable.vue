  ...
  <section class="table-section">
    ...
    <div class="table-container">
      <table class="lot-table">
        <thead>
          <tr>
            <th class="cursor-pointer" @click="toggleSort('lotId')" :aria-sort="sortKey === 'lotId' ? (sortDirection === 'asc' ? 'ascending' : 'descending') : 'none'">LOTID <span>{{ sortKey === 'lotId' ? (sortDirection === 'asc' ? '▲' : '▼') : '⇕' }}</span></th>
            ...
            <th class="cursor-pointer" @click="toggleSort('qty')" :aria-sort="sortKey === 'qty' ? (sortDirection === 'asc' ? 'ascending' : 'descending') : 'none'">QTY <span>{{ sortKey === 'qty' ? (sortDirection === 'asc' ? '▲' : '▼') : '⇕' }}</span></th>
            ...
            <th class="cursor-pointer" @click="toggleSort('package')" :aria-sort="sortKey === 'package' ? (sortDirection === 'asc' ? 'ascending' : 'descending') : 'none'">Package <span>{{ sortKey === 'package' ? (sortDirection === 'asc' ? '▲' : '▼') : '⇕' }}</span></th>
            <th class="cursor-pointer" @click="toggleSort('workcenter')" :aria-sort="sortKey === 'workcenter' ? (sortDirection === 'asc' ? 'ascending' : 'descending') : 'none'">Workcenter <span>{{ sortKey === 'workcenter' ? (sortDirection === 'asc' ? '▲' : '▼') : '⇕' }}</span></th>
            <th class="cursor-pointer" @click="toggleSort('spec')" :aria-sort="sortKey === 'spec' ? (sortDirection === 'asc' ? 'ascending' : 'descending') : 'none'">Spec <span>{{ sortKey === 'spec' ? (sortDirection === 'asc' ? '▲' : '▼') : '⇕' }}</span></th>
            <th class="cursor-pointer" @click="toggleSort('age')" :aria-sort="sortKey === 'age' ? (sortDirection === 'asc' ? 'ascending' : 'descending') : 'none'">Age <span>{{ sortKey === 'age' ? (sortDirection === 'asc' ? '▲' : '▼') : '⇕' }}</span></th>
            <th class="cursor-pointer" @click="toggleSort('holdBy')" :aria-sort="sortKey === 'holdBy' ? (sortDirection === 'asc' ? 'ascending' : 'descending') : 'none'">Hold By <span>{{ sortKey === 'holdBy' ? (sortDirection === 'asc' ? '▲' : '▼') : '⇕' }}</span></th>
            <th class="cursor-pointer" @click="toggleSort('dept')" :aria-sort="sortKey === 'dept' ? (sortDirection === 'asc' ? 'ascending' : 'descending') : 'none'">Dept <span>{{ sortKey === 'dept' ? (sortDirection === 'asc' ? '▲' : '▼') : '⇕' }}</span></th>
