# resource-history-query-diagnostics Specification

## Purpose
Environment-variable-driven configuration for dataset cache TTL and per-service batch engine parallel degree, with unit and e2e test coverage for each configurable parameter.
