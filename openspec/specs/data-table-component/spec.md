## Purpose
Define stable requirements for the DataTable compound shared-ui component.
...
- **THEN** the header SHALL display an ascending (ArrowUp) or descending (ArrowDown) indicator using a Lucide icon
