...
Define the four-plane architecture for classifying cached and queryable data flows across the MES Dashboard backend. All covered modules SHALL be assigned to a plane and conform to that plane's storage and runtime contract.
