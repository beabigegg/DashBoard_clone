## Purpose
Define stable requirements for OEE metrics computation in the resource-history domain, including Oracle SQL queries for production/NG facts and the OEE formula.
