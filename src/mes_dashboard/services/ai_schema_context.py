...
SQL_EXAMPLES: dict[str, list[dict[str, str]]] = {
    ...
    "yield": [
        ...
        },
        {
            ...
            "sql": (
                "SELECT r.WORKCENTERNAME, "
                "SUM(r.REJECTQTY) AS TOTAL_REJECT, "
                "SUM(r.QTYTOPROCESS) AS TOTAL_QTY, "
                "ROUND(SUM(r.REJECTQTY) / NULLIF(SUM(r.QTYTOPROCESS), 0) * 100, 4) AS REJECT_RATE "
                "FROM DWH.DW_MES_LOTREJECTHISTORY r "
